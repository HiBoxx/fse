	...
	<section class="home-hero">
		<div class="container home-hero__inner">
			<div class="home-hero__content">
				...
				<h1 class="home-hero__title"><?php esc_html_e( 'Organisons la solidarité dans les bureaux d\'études, le conseil et l\'expertise et de la Prévention', 'cgt' ); ?></h1>
				...
				<li>
					<a href="<?php echo esc_url( get_stylesheet_directory_uri() . '/archives-fede/index.php' ); ?>" class="home-nav__card home-nav__card--archives">
						...
						<span>
							...
							<small><?php esc_html_e( 'Archives de la fédération.', 'cgt' ); ?></small>
						</span>
					</a>
				</li>
				<li>
