...
<header class="header-bar" role="banner">
	<div class="container header-inner">
		...
		<div class="header-nav">
			...
			<button class="mobile-menu-toggle" type="button" aria-expanded="false" aria-controls="mobile-menu-dropdown">
				<span class="sr-only"><?php esc_html_e( 'Ouvrir le menu', 'cgt' ); ?></span>
...
<div class="mobile-menu-dropdown" id="mobile-menu-dropdown" hidden>
	<nav class="mobile-menu-nav" aria-label="<?php esc_attr_e( 'Menu mobile', 'cgt' ); ?>">
		<?php
		wp_nav_menu(
			array(
